...
public class AuthenticationController {
    ...
    public String processRegistrationForm(@ModelAttribute @Valid RegisterFormDTO registerFormDTO,
        ...
        if (!password.equals(verifyPassword)) {
            ...
            //errors.rejectValue takes 3 parameters: 1. the field containing the error 2. a label representing the error.
            //This allows error messages to be imported from another file. While we don't have such a file, this parameter is required.
